...
app.post('/legends', async (req, res) => {
  try {
    ...
    RETURNING *`, [req.body.name, req.body.special_type_id, req.body.special_group, req.body.type_1, req.body.type_2, req.body.other_forms]);
...
app.put('/legends/:id', async (req, res) => {
  try {
    ...
    where id=$7
    returning *
    `, [req.body.name, req.body.special_type_id, req.body.special_group, req.body.type_1, req.body.type_2, req.body.other_forms, req.params.id]);
